        ...
        Column {
            ...
            Label {
                ...
                <body>
                    ...
                    <ul>
                        <li><b>Назван</b> в честь математика <i>Бенуа Мандельброта</i> (1970-е)</li>
                        <li><b>Самоподобие</b> — граница содержит уменьшенные копии себя</li>
                        <li><b>Бесконечная сложность</b> — новые детали при любом увеличении</li>
                    </ul>
                </body>"
